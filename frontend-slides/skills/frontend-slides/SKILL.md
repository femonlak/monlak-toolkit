...
1. **Extract content** — Run `python references/scripts/extract-pptx.py <input.pptx> <output_dir>` (install python-pptx if needed: `pip install python-pptx`)
...
| [scripts/extract-pptx.py](references/scripts/extract-pptx.py) | Python script for PPT content extraction | Phase 4 (conversion) |
